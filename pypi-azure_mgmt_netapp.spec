...
Version  : 13.3.0
Release  : 33
URL      : https://files.pythonhosted.org/packages/66/94/6d0e04efef6679df2d10c757620fa00f7cb597d2bd3ceeb4dcd158230e24/azure_mgmt_netapp-13.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/66/94/6d0e04efef6679df2d10c757620fa00f7cb597d2bd3ceeb4dcd158230e24/azure_mgmt_netapp-13.3.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_netapp-13.3.0
cd %{_builddir}/azure_mgmt_netapp-13.3.0
pushd ..
cp -a azure_mgmt_netapp-13.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729781891
...
cp %{_builddir}/azure_mgmt_netapp-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_netapp/7aea571d641549de89730da8e7ff5a6940c5526b || :
