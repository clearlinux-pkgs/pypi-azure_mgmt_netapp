...
Source0  : https://files.pythonhosted.org/packages/16/88/a7fcfd24d681b97000a3531371f3629904650cdd54e19dd0ac7b631af402/azure-mgmt-netapp-8.0.0.zip
...
%prep
%setup -q -n azure-mgmt-netapp-8.0.0
cd %{_builddir}/azure-mgmt-netapp-8.0.0
pushd ..
cp -a azure-mgmt-netapp-8.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655393254
...
cp %{_builddir}/azure-mgmt-netapp-8.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_netapp/7aea571d641549de89730da8e7ff5a6940c5526b
