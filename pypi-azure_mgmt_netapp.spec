...
Source0  : https://files.pythonhosted.org/packages/b3/47/688c7a7d7ecea47824a3948ae89db6eb270cffbd83b0b68e6dfae2ffd5d9/azure-mgmt-netapp-9.0.1.zip
...
%prep
%setup -q -n azure-mgmt-netapp-9.0.1
cd %{_builddir}/azure-mgmt-netapp-9.0.1
pushd ..
cp -a azure-mgmt-netapp-9.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672257930
