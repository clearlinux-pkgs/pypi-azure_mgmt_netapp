...
Version  : 13.4.0
Release  : 35
URL      : https://files.pythonhosted.org/packages/74/56/7fb9466085696bfa06a5d755d45a4304d2d129eada6d0e553ba502dffb39/azure_mgmt_netapp-13.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/74/56/7fb9466085696bfa06a5d755d45a4304d2d129eada6d0e553ba502dffb39/azure_mgmt_netapp-13.4.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_netapp-13.4.0
cd %{_builddir}/azure_mgmt_netapp-13.4.0
pushd ..
cp -a azure_mgmt_netapp-13.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740587446
