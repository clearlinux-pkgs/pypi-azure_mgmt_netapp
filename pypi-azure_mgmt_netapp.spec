...
Source0  : https://files.pythonhosted.org/packages/70/79/4f5345ee755d4304a1a16ffeb0b75f6971387b1be8a0d5ffeb0d846a9e76/azure-mgmt-netapp-8.1.0.zip
...
%prep
%setup -q -n azure-mgmt-netapp-8.1.0
cd %{_builddir}/azure-mgmt-netapp-8.1.0
pushd ..
cp -a azure-mgmt-netapp-8.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659451876
