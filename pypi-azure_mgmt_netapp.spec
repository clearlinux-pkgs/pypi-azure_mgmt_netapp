...
Source0  : https://files.pythonhosted.org/packages/f4/ca/e296fb9cdaa78410f0152acd8255c7338c2de3ca83e4e060f3fa999c39d6/azure-mgmt-netapp-6.0.1.zip
...
%prep
%setup -q -n azure-mgmt-netapp-6.0.1
cd %{_builddir}/azure-mgmt-netapp-6.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642088032
...
cp %{_builddir}/azure-mgmt-netapp-6.0.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_netapp/7aea571d641549de89730da8e7ff5a6940c5526b
